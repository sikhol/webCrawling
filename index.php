...
<html>
 <head>
  <title>Web Crawler Using DFS</title>
 </head>
 <body>
  <div id="content" style="margin-top:10px;height:100%;">
   <center><h1>Web Crawler in DFS</h1></center>
   <form action="index.php" method="POST">
    URL : <input name="url" size="35" placeholder=""/>
    <input type="submit" name="submit" value="Start Crawling"/>
   </form>
   <br/>
   <b>Url Yang telah di Crawling</b><br/>Lihat Semua Url Yang telah di Crawling <a href="url-crawled.html">disini</a>.
   <?
   ...
   if(isset($_POST['submit'])){
    ...
    if($url==''){
     ...
     fclose($f);
     echo "<h2>Hasil - URL's Ditemukan</h2><ul style='word-wrap: break-word;width: 400px;line-height: 25px;'>";
     crawl_site($url);
     echo "</ul>";
    }
   }
